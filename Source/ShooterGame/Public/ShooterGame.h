...
// Gauntlet no longer exports the sample's historical logging category.
#define LogGauntlet LogShooter
...
#if (defined(PLATFORM_PS4) && PLATFORM_PS4) || PLATFORM_SWITCH || SHOOTER_SIMULATE_CONSOLE_UI
