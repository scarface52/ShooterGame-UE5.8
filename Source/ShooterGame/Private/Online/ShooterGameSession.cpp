...
{
	const int32 NextSessionIndex = CurrentSessionParams.BestSessionIdx + 1;
	CurrentSessionParams.BestSessionIdx = SearchSettings->SearchResults.IsValidIndex(NextSessionIndex)
		? NextSessionIndex
		: -1;
}
