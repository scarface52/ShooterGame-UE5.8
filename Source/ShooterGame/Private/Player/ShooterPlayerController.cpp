...
{
	InputKey(FInputKeyParams(Key, bPressed ? IE_Pressed : IE_Released, 1.0, false));
}
...
void AShooterPlayerController::ClientReturnToMainMenuWithTextReason_Implementation(const FText& InReturnReason)
{		
	const UWorld* World = GetWorld();
